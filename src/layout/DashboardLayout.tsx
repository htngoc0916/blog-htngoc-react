    ...
    <div className='bg-gray-50 dark:bg-darkbg'>
      <div className='flex h-screen'>
        ...
        <div className='relative flex flex-col flex-1 overflow-x-hidden overflow-y-auto'>
          <DashboardHeader className='sticky top-0 left-0 w-full z-[999] bg-white border-b shadow-sm border-text7 dark:border-text3 dark:bg-darkbg3 backdrop-filter backdrop-blur-lg bg-opacity-60 firefox:bg-opacity-90 transition-all'></DashboardHeader>
