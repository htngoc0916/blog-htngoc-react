...
export const USER_CHECK_EMAIL = `${API_VERSION}/users/check-email`
...
export const MENU_GET_BY_CODE = `${API_VERSION}/menus/menu-code`
...
export const POST_CHECK_TITLE = `${API_VERSION}/posts/check-title`
export const POST_GET_BY_CATEGORY = `${API_VERSION}/posts/category`
export const POST_GET_HOT_POST = `${API_VERSION}/posts/hot-posts`
...
export const CONTACT_SEND_IDEA = `${API_VERSION}/contacts/send-idea`
export const CONTACT_SEND_CONTACT = `${API_VERSION}/contacts/send-contact`
