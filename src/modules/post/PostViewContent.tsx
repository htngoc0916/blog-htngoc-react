  ...
  return (
    <div id='post-detail__content' className='grid grid-cols-1 gap-2 lg:pt-16 lg:grid-cols-12'>
      <div className='lg:col-span-1'>
        <div className='sticky flex flex-col items-center justify-center gap-2 top-[140px]'>
          <Tooltip content='Chia sẽ bài viết đến trang Facebook' placement='right' className='w-64'>
          ...
          <Tooltip content='Yêu thích bài viết này' placement='right' className='w-44'>
            <Button color='secondary' pill className='flex items-center justify-center w-10 h-10'>
